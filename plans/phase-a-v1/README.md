...
| 07 | Gather | #412 | Per-name packet assembly under a hard budget with batching and merge, disagreement text written onto the name page, name-to-name links, plus a per-name disagreement record on disk (provenance for #447's undecided quality measure) | ◐ in-progress | #467 |
