...
> evidence base). The table below reflects the corrected plan; the original
> HDBSCAN-gated design is kept only as history in TRACKER.md. Full reasoning
> and every number: **DEC-37**, **DEC-38**.
