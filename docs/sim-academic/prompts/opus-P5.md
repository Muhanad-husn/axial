# Prompt package — Opus 4.8 (claude.ai) as Persona P5
...
## Before you start
Enable Extended Thinking. **Exclude personal memory from this task** — do not draw on
any stored memory or personalization; work only from the attached files and this
prompt.
...
1. **Research briefs — 5 or 6.** The research questions you would genuinely put to
   ...
   (`P5-01.yaml` …), shape `{case, request}`, `lens` omitted.
...
works you know best (Kalyvas, Üngör, Elcheroth & Reicher, Chouliaraki, Agamben). Be
specific and field-serious, not generic. Produce the output as downloadable files.
